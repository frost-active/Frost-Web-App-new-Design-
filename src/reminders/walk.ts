...
export function buildWalkReminder(config: DeviceConfig): WindowReminder {
  const source = config.reminders.walk;
  return {
    k: 'walk', label: 'Walk', color: '--c-walk', src: 'walk', type: 'win',
